...
function get_tplink_running_config($router)
{
    ...
    try {
        ...
        $switch_name = array_reduce(
            explode("\n", $t->cmd("show system-info")),
            function ($acc, $item) {
...
{
    $patterns[] = "/Fa/";
    $replacements[] = "fastEthernet ";
    $patterns[] = "/Gi/";
    $replacements[] = "gigabitEthernet ";
